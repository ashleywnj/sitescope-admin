...
function AdminAccessContent({ user }: AdminAccessProps) {
  ...
  return (
    <Link
      href="/admin"
      className="flex items-center px-3 py-2 text-sm font-medium text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-all duration-200"
